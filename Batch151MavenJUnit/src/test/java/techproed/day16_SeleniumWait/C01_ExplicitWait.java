...
public class C01_ExplicitWait extends TestBase {
    ...
    public void test01() {
        ...
        //Locate'ini aldigimiz helloWorldText webelementini gorunur olana kadar explicit wait ile bekleyecegim.
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20)); // max 20 sn belirttik
        wait.until(ExpectedConditions.visibilityOf(helloWorldText));
        //visibilitiOf() methoduyla gorunur olana kadar bekler.
