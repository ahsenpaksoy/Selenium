...
public class C03_KeyDownKeyUp extends TestBase {
    ...
    //Action class'i mouse ile isimiz oldugunda kullaniriz. Klavye ile islem yapacagimizda action'dan obje olusturmaya
    // gerek yok direk Keys.SHIFT kullanabiliriz
