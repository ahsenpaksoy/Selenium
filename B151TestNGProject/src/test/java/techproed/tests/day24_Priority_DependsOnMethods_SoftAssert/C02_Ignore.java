...
public class C02_Ignore {
    ...
    eklememiz yeterlidir.@Ignore notasyonu ile atladığımız method konsolda gözükmez raporlamalarda gözükür
       Eger bir methodu tamamen iptal etmek isterseniz @Test notasyonundan sonra parametre olarak
    (enabled = false) kullanabilirsiniz. (enabled = false) raporlamalarda gozukmez
     */
    @Ignore
    @Test
