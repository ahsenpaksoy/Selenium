...
public class C01_Annotation {
    ...
    @BeforeTest
    public void beforeTest() {  //test classindaki testlerin hepsinden once 1 kez calisir
        System.out.println("Testlerden önce bir kez çalışır");
    }
    @BeforeClass
    public void beforeClass() {
        System.out.println("Her class'dBeforean önce bir kez çalışır");
    }
    @BeforeMethod
    public void setUp() {
    ...
    @AfterTest
    public void afterTest() {  //test classindaki testlerin hepsinden sonra 1 kez calisir
   ...
   /*
      Hocam BeforeSuite , test ve class en basta bir sefer ..AfterSuite, test ve class en son da
      bir sefer calisir before ve after methodlar ise her testin basinda sonunda bir kez calisir
    */
